...
7. Explique que o GET trouxe novamente os dados do banco.
8. Mostre o `map`, que transforma cada destino em card.
9. Encerre mostrando a divisão Front-end, API e H2.

### Fala curta sugerida

> O Além da Rota é uma aplicação de turismo dividida em Front-end React e Back-end Spring Boot. O formulário possui sete campos controlados por estado. Ao enviar, o service faz um POST em JSON. O Controller recebe e valida o destino e usa JdbcTemplate para executar o INSERT no H2. Depois, a aplicação navega para a consulta, executa um GET, e o JdbcTemplate realiza o SELECT. O React usa map para transformar os dados em cards.
...
- [ ] Comparar a seção de auditoria com o enunciado original.
- [x] Corrigir o Maven Wrapper e executar com Java 21.
- [x] Testar GET, POST e validação com um banco H2 temporário.
- [ ] Iniciar o Front-end e cadastrar um destino de demonstração.
- [ ] Testar API desligada para conhecer a mensagem de erro.
- [ ] Confirmar se arquivos sem uso podem ser removidos.
- [ ] Ensaiar a fala curta e as perguntas prováveis.
